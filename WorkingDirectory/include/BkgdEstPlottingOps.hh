...
namespace Operation {
 ...
 class ABCDMethod : public PlottingBase  {
   ...
   public:
     ...
     */
     ABCDMethod(const std::string& fileName ,TString processName,TString var1Name,TString var2Name,UInt_t numberBinsVar1,float MinVar1,float MinVar2, UInt_t numberBinsVar2, float MinVar2,float MaxVar2, const std::vector<Double_t>&lrange, const std::vector<Double_t>&hrange,Int_t minNumJets,Int_t maxNumJets);
 ...
 Int_t MinNumJets;
  ...
  public:
   ...
   private:
     ...
     ABCDMethod** * alphaT_vs_etaLeading_HT;

     ABCDMethod** * MHTovHT_vs_etaLeading_HT;
     ABCDMethod** * ThrustDeltaPhi_vs_etaLeading_HT;
     ABCDMethod** * MissingTransverse_vs_etaLeading_HT;
     ABCDMethod** * MissingTransverse_vs_etaLeading_Meff;
     ABCDMethod** * MHT_vs_etaLeading_HT;
