...
//   }
...

  {
    ...
    //<< " CC: " << std::setw(1) << iphoton->WasItcc()
     ...
     << " TrkIso: " << std::setw(8) << std::setprecision(4) << iphoton->GetTrackIsolation()
     << " EcalIso: " << std::setw(8) << std::setprecision(4) << iphoton->GetEcalIsolation()
     << " HcalIso: " << std::setw(8) << std::setprecision(4) << iphoton->GetHcalIsolation()
     << " AllIso:  " << std::setw(8) << std::setprecision(4) << iphoton->GetAllIsolation()
     << std::endl;
    }
