...
Plots_NoCleaningCuts = PL_TriggerTurnOns( PSet(DirName = "Plots_HT275_NoCleaning", MinObjects =0 ,MaxObjects = 15,Plots = True, ReWeight = False,TriggerReWeight = datatriggerps.Triggers,Verbose = False).ps())
